...
(function() { this.JST || (this.JST = {}); this.JST["views/elements/arrow_infos"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() {
  ...
  $(function() {
    ...
    return $("body").on("click", ".app_lnk", function() {
      return $("#app_content").html($(renderView($(this).attr("data-target"))));
    });
  });
